...
<nav class="red">
  <div class="nav-wrapper container ">
    ...
    <ul class="right ">                                 
      ...
      <li>
        <a href="#" class="dropdown-trigger" data-target='dropdown2'>Olá! {{ auth()->user()->firstName }}<i class="material-icons right">expand_more</i>
        </a>
      </li>     
    </ul>
...
<ul id="slide-out" class="sidenav " >
  <li><div class="user-view">
    ...
    <li>
      <a href="{{route('admin.produtos')}}"><i class="material-icons">playlist_add_circle</i>Produtos</a>
    </li>
    <li>
      <a href="#!"><i class="material-icons">shopping_cart</i>Pedidos</a>
    </li>
    <li>
      <a href="#!"><i class="material-icons">bookmarks</i>Categorias</a>
    </li>
    <li>
      <a href="#!"><i class="material-icons">peoples</i>Usuários</a>
    </li>
</ul>
